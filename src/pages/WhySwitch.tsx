    ...
    <div className="min-h-screen bg-gradient-to-br from-primary/5 to-accent/5 bg-pattern">
      ...
      <section className="relative py-20 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <div className="inline-flex items-center px-6 py-3 rounded-full bg-accent/10 text-accent text-sm font-medium mb-8 animate-fade-in hover-bounce border border-accent/20">
          ...
          <Card className="card-vibrant animate-scale-in">
            <CardContent className="p-8">
              <div className="flex items-center justify-center mb-4">
                <div className="w-16 h-16 bg-gradient-to-r from-primary to-accent rounded-full flex items-center justify-center floating-element">
                  <Calculator className="h-8 w-8 text-white" />
                </div>
              </div>
              <h2 className="text-2xl font-bold mb-4 gradient-text-electric">
